...
class AirDrawing:
    ...
    def process_frame(self, frame, draw_color=(0, 255, 0), erase_color=(255, 0, 0)):
        ...
        results: mp.python.solution_base.SolutionOutputs = self.hands.process(rgb_frame)
...
def main():
    ...
    while True:
        ...
        # we flip the frame horizontally for easier drawing
        frame = cv2.flip(frame, 1)

        # process frame (colors in bgr format)
        output = air_drawing.process_frame(frame, (0, 255, 0), (0, 0, 255))
